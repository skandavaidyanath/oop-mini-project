...
public class DeleteTF extends JFrame {
	...
	public DeleteTF() {
		...
		JList list = new JList(RunApp.current.tfquiz.toArray());
		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
					TFQuestion q = (TFQuestion) list.getSelectedValue();
