...
public class ModifyMCQ extends JFrame {
	...
	public ModifyMCQ() {
		...
		JLabel label = new JLabel("Modify a question ");
		label.setHorizontalAlignment(SwingConstants.CENTER);
		label.setFont(new Font("BankGothic Md BT", Font.BOLD, 20));
		label.setBounds(49, 11, 327, 14);
		contentPane.add(label);
		
		JSeparator separator = new JSeparator();
		separator.setBounds(49, 36, 327, 2);
		contentPane.add(separator);
		
		JLabel label_1 = new JLabel("Enter a keyword to search");
		label_1.setBounds(25, 49, 134, 14);
		contentPane.add(label_1);
		
		keyword = new JTextField();
		keyword.setColumns(10);
		keyword.setBounds(169, 49, 110, 20);
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				q.options[0] = option1.getText();
				q.options[1] = option2.getText();
				q.options[2] = option3.getText();
				q.options[3] = option4.getText();
				RunApp.current.mcqquiz.add(q);
		...
		button_1.setBounds(99, 236, 89, 23);
		...
		btnCancel.setBounds(238, 236, 89, 23);
